...
class MutationHolder(chunkHandle: Long, chunkAllocator: ActorRef<Allocator.Command>, system: ActorSystem<Void>) {
    ...
    private val payloadData = HashMap<String, ByteArray>()
    ...
    fun commitMutation(
        clientId: String,
        chunkBlocks: HashMap<String, ChunkData>,
    ...
    fun addPayloadData(mutationId: String, payload: ByteArray) {
        payloadData[mutationId] = payload
    }
